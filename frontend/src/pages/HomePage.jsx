    ...
    <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
      <section className="rounded-2xl border border-slate-200 bg-white p-10 shadow-card">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-ink-muted">
          Навчальний MVP: відстеження посилок та панель диспетчера з JWT після входу. Усі дії — у меню згори.
        </p>
        ...
        {!loading && user ? (
          <p className="mt-6 text-sm text-ink-muted">
            ...
            , щоб керувати довідниками, або до{' '}
            <Link className="font-medium text-brand-600 hover:text-brand-800" to="/track">
              відстеження
            </Link>
            .
          </p>
